...
assert(not has_normal_mapping("<Space>r"), "retry mapping was shown before review")
assert(has_normal_mapping("<Space>o"), "open notes mapping was not registered")
assert(has_normal_mapping("<Space>t"), "statistics mapping was not registered")
...
assert(has_normal_mapping("<Space>a"), "accept mapping was not registered while reviewing")
