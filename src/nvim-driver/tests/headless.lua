...
assert(vim.fn.maparg("<Space>s", "n") ~= "", "start mapping was not registered")
assert(vim.fn.maparg("<Space>a", "n") ~= "", "accept mapping was not registered")
assert(vim.fn.maparg("<Space>r", "n") ~= "", "retry mapping was not registered")
assert(vim.fn.maparg("<Space>m", "n") ~= "", "note mapping was not registered")
assert(vim.fn.maparg("<Space>f", "n") ~= "", "follow-up mapping was not registered")
assert(vim.fn.maparg("<Space>i", "n") ~= "", "fold imports mapping was not registered")
assert(vim.fn.maparg("<Space>m", "x") ~= "", "visual note mapping was not registered")
assert(vim.fn.maparg("<Space>o", "n") ~= "", "open notes mapping was not registered")
assert(vim.fn.maparg("<Space>t", "n") ~= "", "statistics mapping was not registered")
