...
function M.open_stats(stats)
  ...
  local lines = {
    ...
    string.format("Cards: %d total · %d unseen · %d due now · %d bookmarked",
      state.total, state.unseen, state.due_now, state.open_bookmarks),
    string.format("Reviews: %d · Reveals: %d · Hints: %d · Give-ups: %d",
      reviews.total, reviews.revealed, reviews.hint_used, reviews.gave_up),
